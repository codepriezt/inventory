                ...
                <div class="automobile-shop-wrap">
                    <div class="automobile-shop-slide">
                      <div class="automobile-shop-thumb">
                          <div class="automobile-images-thumb-layer"><span><img src="{{asset('asset_main/extra-images/account-profile.jpg')}}" alt=""></div>
                          <div class="automobile-images-thumb-layer"><span><img src="{{asset('asset_main/extra-images/accoun-profile.jpg')}}" alt=""></div>
                      </div>
                    ...
                    <div class="automobile-shop-summery">
                        ...
                        <div class>
                          ...
                          <input type="hidden" name="status" value="{{$user->status}}" disabled>
                          <input type="hidden" name="_token" value="{{csrf_token()}}">
                            @if($user->status == 'inactive')
                            <button type="submit" class="btn btn-danger">{{$user->status == 'inactive' ?'Make active': 'inactive'}}</button>
                            @endif
                            @if($user->status == 'active')
                            <button type="submit" class="btn btn-success" >{{$user->status == 'active' ?'Make inactive': 'active'}}</button>
                            @endif
                            </form>
                        </div>
                        <hr>
